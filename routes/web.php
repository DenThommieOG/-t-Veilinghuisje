...
Route::post('/auction/item/store', [ItemController::class, 'store'])->name('item.store');
Route::get('/auction/item/show/{id}', [ItemController::class, 'show'])->name('item.show');
Route::get('/auction/item/edit/{id}', [ItemController::class, 'edit'])->name('item.edit');
Route::post('/auction/item/update', [ItemController::class, 'update'])->name('item.update');
Route::delete('/auction/item/destroy/{item}', [ItemController::class, 'destroy'])->name('item.destroy');
